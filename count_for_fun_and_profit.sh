...
sparql/count-literal-resource-property-ranges.rq
sparql/count-untyped.rq
sparql/count-types.rq
sparql/count-dctypes.rq
...
http://data.dm2e.eu/data/dataset/sbb/kpe/20140417133253835
...
for dataset_uri in ${datasets[@]};do
    ...
    for query in ${query_files[@]};do 
        ...
        echo "[$cur / $total] $dataset_clean <$dataset_uri> -> $query -> $outname"
